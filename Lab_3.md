...
([source](https://llvm.org/docs/TestingGuide.html)). Make sure, you have it installed, by running the following command: 
<!-- Line 49 mistake, unintended new line -->
```sh
# Ubuntu
...
<!-- line 92 - Should be slide 17? Lecture 14 is needed but for understanding sreg, not lfsr -->
...
<!--  line 102 - slide 17 is wrong, lacking the internal signal, should be figured out easily though. -->
